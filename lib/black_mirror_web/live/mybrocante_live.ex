      ...
      <div class="grid grid-cols-7 text-3xl">
        ...
        <div class="col-span-4 space-y-3">
          <div class="grid grid-cols-2">
            <div class="col-span-1 myb-red-color text-6xl font-bold">+<%= @mybrocante.current_month_new_users %></div>
            <div class="col-span-1">
              <div class="font-bold"><%= @mybrocante.total_users %></div>
              <div class="text-gray-500">Clients</div>
            </div>
          </div>
          <div class="myb-blue-color text-6xl font-bold"><%= @mybrocante.current_month_sales %> €</div>
        </div>
        ...
        <div class="col-span-2 space-y-3">
          <div>
            <div class="font-bold"><%= Float.round(@mybrocante.year_sales/100)  %> €</div>
