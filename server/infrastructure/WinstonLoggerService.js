const LoggerService = require("../../../application/interfaces/LoggerService");
...
module.exports = class WinstonLoggerService extends LoggerService {
    constructor() {
        super();
    }

    error(msg, obj) {
        return winston.error(msg, obj);
    }
};
