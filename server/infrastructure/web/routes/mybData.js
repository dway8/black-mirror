...
const MybDataController = require("../../../controllers/MybDataController");

const mybDataRouter = dependencies => {
    const router = express.Router();

    const controller = MybDataController(dependencies);

    router
        .route("/")
        .get(controller.getCurrentMybDataAndOpenings)
        .post(controller.handleMybEvent);

    router.route("/update").use(controller.updateMybData);

    return router;
};

module.exports = mybDataRouter;
